...
public class addActivity extends AppCompatActivity {
    ...
    Button ok, again, go,eemploy;
    EditText kidID, fingerId, fatherId, kidName, phone, phone2, phone3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eemploy= findViewById(R.id.employ);
        ...
        eemploy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(addActivity.this, addEmployee.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String phoneValue3 = phone3.getText().toString();

                if (fingerIdText.isEmpty() || fatherIdValue.isEmpty() || kidNameValue.isEmpty()) {
                    Toast.makeText(addActivity.this, "يرجى ملء جميع الحقول المطلوبة", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    ...
                    generateStudentId(new OnIdGenerated() {
                        @Override
                    ...
                    Toast.makeText(addActivity.this, "الرجاء إدخال رقم صحيح لـ Finger ID", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(addActivity.this, activate.class);
                startActivity(mainIntent);
            }
        });
    ...
    private void previewStudentId() {
        ...
        counterRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(addActivity.this, "فشل في قراءة رقم الطالب", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void generateStudentId(@NonNull OnIdGenerated callback) {
        DatabaseReference counterRef = FirebaseDatabase.getInstance().getReference(mainCollection).child("studentCounter");
        String currentDate = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH).format(new Date());
        ...
        counterRef.runTransaction(new com.google.firebase.database.Transaction.Handler() {
            ...
            public void onComplete(@Nullable DatabaseError error, boolean committed, @Nullable DataSnapshot currentData) {
                if (committed && currentData != null) {
                    ...
                    Toast.makeText(addActivity.this, "خطأ في توليد رقم الطالب", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void saveDataToFirebase(String kidId, int fingerId, String fatherId, String kidName, String phone, String phone2, String phone3) {
        ...
        databaseRefer.child("users").child(fatherId).child("id").setValue(fatherId);
        databaseRefer.child("users").child(fatherId).child("name").setValue(kidName);
        databaseRefer.child("users").child(fatherId).child("KidId").setValue(kidId);
